...
const { executeBridgeCommand } = require("./coordination/host-event-bridge");
const { buildAnchor, PKG_VERSION: ANCHOR_PKG_VERSION } = require("./anchor/anchor");
...
module.exports = {
  ...
  topology: require("./commands/topology").topologyCommand,
  automation: require("./commands/automation").automationCommand,
  skillBrowse: require("./commands/skill-browse").skillBrowseCommand,
  localPublishValidate: require("./commands/local-publish-validate").localPublishValidate,
  proposalShare: require("./commands/proposal-share").proposalShare,
};