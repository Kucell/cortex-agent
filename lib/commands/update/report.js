...
function buildAppliedUpdateReport(ctx, {
  ...
  return {
    ...
    next_actions: [
      ...
      ...(migrationReport && !migrationReport.migration.is_noop ? ["Run cortex-agent update --verify to validate runtime layout migration."] : []),
    ],
    migration: migrationReport || undefined,
  };
}
