...
const { leaseAcquire, leaseRelease, LeaseCliError } = require("./coordination/lease-cli");
...
const { dispatch: capabilityAwareDispatch } = require("./runtime-adapters/capability-aware-dispatch");
const boundaryEvent = require("./runtime-adapters/boundary-event");
