...
// M-031 MS-001 (P-007 host adapter completeness round, approved D-ARI-P007-host-completeness
// revision 4c50a96c...): adds `cursor` to the EXT union so the observer-mode
// adapter at lib/agents/adapters/cursor.js is dispatchable via
// `cortex-agent agent adapter list` without touching lib/agents/registry.js
// (M-002 frozen main table).
const VALID_ADAPTER_TYPES_EXT = Object.freeze(["minimax", "dsh", "cursor"]);
