...
const { createAgentReporterFromContext, createAgentReporter, AGENT_SCOPED_EVENT_TYPES } = require("./agent-reporter");
...
function parseBridgeArgs(argv) {
  ...
  if (evidenceRef) {
    reportInput.evidence = [{ kind: "cli_ref", ref: evidenceRef }];
  }
