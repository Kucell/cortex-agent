...
} = require("../../lib/runtime-adapters/capability-aware-dispatch.js");
...
test("VC-009-02 automatic dispatch and daemon are explicitly disabled and never flipped on by the module", () => {
  const { AUTOMATIC_DISPATCH_ENABLED, DAEMON_ENABLED } = require("../../lib/runtime-adapters/capability-aware-dispatch.js");
