...
| Tier | Default controls | Prohibited without separate Decision |
| :--- | :--- | :--- |
...
These fields are payload/template conventions first. Promote them to a cross-host schema requirement only after fixture and pilot evidence demonstrates interoperability need.
...
Risk tier must appear in a Spec or Plan artifact; a missing or unknown tier is treated as high before execution.
