...
installCommand: "manual — see raven.md"
configPath: null
mcpBridge: null
capabilities:
  - prompt:inject
...
Raven CLI agent(open-design 上游支持 `od mcp install raven`)。cortex-agent 侧契约已文档化。
