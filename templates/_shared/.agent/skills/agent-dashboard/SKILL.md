...
Links and inline-code document paths inside previewed Markdown stay navigable: supported project-relative documents open in the same preview dialog, anchors scroll within the document, and external URLs open in a new tab. Do not duplicate references in a separate preview list.
