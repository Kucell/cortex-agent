---
title: "Project Context Imported from CLAUDE.md"
...
module_path: ".agent/references/ + .agent/imported_rules/imported_from_CLAUDE.md.md (源)"
module_type: "Legacy 上下文快照 (imported from CLAUDE.md)"
---

# Project Context Imported from CLAUDE.md
