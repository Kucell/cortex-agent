---
module: visualize-design-tokens
module_path: .agent/references/visualize/design-tokens.md
module_type: "Visualize Design Tokens (上游 vendored)"
keywords: [visualize, design, theme-tokens, base-classes, dsh-visualize, upstream]
status: stable
owner: cortex-agent
last_verified: 2026-08-20
verified_by: cortex-agent maintainers
sources:
  - https://github.com/Nagi-ovo/dsh-visualize/blob/main/assets/references/design.md
  - https://github.com/Nagi-ovo/dsh-visualize/blob/main/LICENSE
summary: "Design tokens, theme variables, base classes — vendored from Nagi-ovo/dsh-visualize (BSD-3-Clause)"
---

# Design — Theme Tokens & Base Classes (vendored)

> **Source**: https://github.com/Nagi-ovo/dsh-visualize/blob/main/assets/references/design.md
> **License**: BSD-3-Clause (Copyright (c) 2026 Jesse Zhang)
> **Vendored by**: cortex-agent on 2026-08-20

The text below is the upstream design reference, vendored verbatim. It defines
the theme variables, base classes, and layout rules that any inline-HTML
fragment should follow when rendered by a DSH-style card.
